		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Saída de Guias",
									"targetURL": "#saciatransferout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saciatransferout-display": {
								"semanticObject": "saciatransferout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sacia.transfer.out",
									"url": sap.ui.require.toUrl("sacia/transfer/out")
								}
							}
						}
					}
